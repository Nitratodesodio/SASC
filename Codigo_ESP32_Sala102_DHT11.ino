...
const char* mqtt_topic = "102"; //Topico de la sala (Reemplazar por el numero de sala)
const char* mqtt_topic_temp = "102/temp"; // tópico para la temperatura
const char* mqtt_topic_pres = "102/pres"; // tópico para la temperatura
const char* mqtt_topic_moving = "102/mov";
